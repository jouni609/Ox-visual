...
> **Curation note (2026-09-04):** this showcase was reviewed end-to-end and cut to the sets that pass the acceptance baseline — at least **4 of 5 designs** in a set must render a recognizable ox. Ten sets failed and were removed; the full review lives in [SCORECARD.md](SCORECARD.md), the passing sets are ranked in [LEADERBOARD.md](LEADERBOARD.md), and the removed ones are recorded in [WALLOFSHAME.md](WALLOFSHAME.md).
