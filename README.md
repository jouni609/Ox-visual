...
<details>
  <summary><strong>Set XXVIII — OX APPARATUS</strong> · five working systems of the ox · <em>designed by Space Bunny</em></summary>

Five body systems treated as working instruments, each with its own material world and a different full ox figure.

| # | Design | Facet | Direction |
|---|--------|-------|-----------|
| 01 | **Rumen** | Anatomy | Clinical anatomy bench: complete low-headed ox, animated rumen window, scan line, stitched specimen label |
| 02 | **Whorl** | Breed | Saturated paint field: three-quarter zebu with broad lyre horns, spotted coat, swatch board, tilted paint-card signature |
| 03 | **Beam** | Labour | Engineered pull-test stage: four-legged draught ox under a yoke, measured force, patterned timber, riveted plate |
| 04 | **Bell** | Herd sense | Dusk pasture collage: walking cow in full profile, swinging bell and expanding sound waves, stitched leather herd tag |
| 05 | **Hoof** | Region | Himalayan contour field: three-legged yak with broad horns and long coat, pulsing hoof marks, stamped rock plate |
